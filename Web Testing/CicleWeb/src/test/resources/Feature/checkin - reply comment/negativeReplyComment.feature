...
Feature: Functional reply comment
  ...
  Scenario:User reply comment with input empty text in tell your story field
  ...
  Scenario:User reply comment with input empty text using space button as empty character in tell your story field
    Given Navigate user to checkin page
      When User click one of question detail
        And User click reply comment button
        And User click add new comment field
