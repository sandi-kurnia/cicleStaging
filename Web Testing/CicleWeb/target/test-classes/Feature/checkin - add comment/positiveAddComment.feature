...
Feature: Functional add comment
  ...
  Scenario:User add new comment by input text in tell your story field
  ...
  Scenario:Verify insert files by upload supported in the tell your story field
    Given Navigate user to checkin page
      When User click one of question detail
        And User click add new comment field
        And User click tell your story field
  ...
  @Positive-Add_Comment-10
  Scenario:Verify insert files by input files using valid url
    Given Navigate user to checkin page
      When User click one of question detail
        And User click add new comment field
        And User click tell your story field
  ...
  @Positive-Add_Comment-15
  Scenario:User cancels to add new comment
    Given Navigate user to checkin page
      When User click one of question detail
        And User click add new comment field
        And User click tell your story field
