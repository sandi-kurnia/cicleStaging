...
Feature: Functional Add Checkin
  ...
  Scenario: User Add New Check-In
  ...
  Scenario: User Add New Check-In with Select All Day
    Given Navigate user to checkin page
    When User tap create checkin button
    And User tap type your question field
    And User input text in type your question field
  ...
  Scenario: User Add New Check-In for Private Only
    Given Navigate user to checkin page
      When User tap create checkin button
        And User tap type your question field
        And User input text in type your question field
  ...
  Scenario: User Add New Check-In with unselect all member companies to be notified
    Given Navigate user to checkin page
      When User tap create checkin button
        And User tap type your question field
        And User input text in type your question field
