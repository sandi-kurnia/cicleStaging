@Negative-Reply_Comment-Feature
Feature: Functional Reply Comment
  ...
  @Negative-Reply_Comment-01
  Scenario: User reply comment without input text in tell your story field
  ...
  @Negative-Reply_Comment-02
  Scenario: User reply comment with empty text using space button as character in tell your story field
    Given Navigate user to checkin page
      When User tap one of question detail
        And User tap reply button
        And User tap add comment field
  ...
  @Negative-Reply_Comment-03
  Scenario: User add image by invalid url
    Given Navigate user to checkin page
      When User tap one of question detail
        And User tap reply button
        And User tap add comment field
  ...
  @Negative-Reply_Comment-04
  Scenario: User add file by invalid url
    Given Navigate user to checkin page
      When User tap one of question detail
        And User tap reply button
        And User tap add comment field
  ...
  @Negative-Reply_Comment-05
  Scenario: User add video by invalid url
    Given Navigate user to checkin page
      When User tap one of question detail
        And User tap reply button
        And User tap add comment field
